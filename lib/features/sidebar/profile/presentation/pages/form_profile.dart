    ...
    return BlocBuilder<UserProfileBloc, UserProfileState>(
      builder: (context, state) {
        ...
        return Skeletonizer(
          ...
          child: ListView(
            children: [
              const Text("Administra tu información personal y preferencias",
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    TextButton(onPressed: () {}, child: const Text("Cambiar Foto"))
                  ],
                ),
              ),
              ...
              _buildTextField("Dirección", _addressController, (value) {
                context.read<UserProfileBloc>().add(UpdateField(address: value));
              }),
              ...
              SwitchListTile(
                ...
                onChanged: (value) {
                  context.read<UserProfileBloc>().add(UpdateField(pushNotifications: value));
                },
              ),
              const SizedBox(height: 16),
              Center(
